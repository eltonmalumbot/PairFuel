...
assert.match(dashboard, /water: pw \?\? \{ amount_ml: 0 \}/, "Partner water must safely fall back to 0");
...
assert.match(dashboard, /isolationLevel: "Serializable"/, "Partner transaction must remain serializable");
